...
interface TransactionCardProps {
  ...
  deleteTransaction: (deleteTrId: string | undefined, isLoading: boolean, currentUser: User | null, setIsLoading: Dispatch<SetStateAction<boolean>>,
    updateCurrentBalance: (value: number) => void, updateLedger?: (currency: string, amount: number) => void) => void
  isLoading: boolean
...
const TransactionCard: React.FC<TransactionCardProps> = ({ value, screenWidth, transaction, setCategoryFilter, deleteTransaction, widthRatio, iconDisabled, isLoading, setIsLoading }) => {
  ...
  function deleteTr() {
    deleteTransaction(transaction.id, isLoading, currentUser, setIsLoading, updateCurrentBalance, updateLedger)
    toggleShowDeleteQ()
    toggleExpanded()
  }
